...
<gameSystem id="fd97-5cfe-d46c-03c6" name="Warhammer Fantasy - 6ª Edición con RDC - v1.0" revision="6" battleScribeVersion="2.03" authorName="Leyendas en miniatura" authorContact="leyendasenminiatura@gmail.com" authorUrl="http://www.leyendasenminiatura.com/" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <costTypes>
...
Actuarán como una unidad independiente el resto de la batalla. No es posible resucitar la Esfinge aunque la dotación (o personaje) sigan vivos.</description>
    ...
    <rule id="c20a-b606-35da-0478" name="Monstruo arcano" hidden="false">
      <description>Cualquier ejército de Warhammer, incluyendo Mercenarios y Bretonia, puede incluir Monstruos Arcanos, como una opción de unidad Singular.
Sólo puedes incluir una miniatura de la sección de Monstruos Arcanos por cada 2000 puntos. Así, una partida a 1500 puntos no permitiría ningún Monstruo Arcano, mientras que una partida a 4.500 puntos permitiría dos. </description>
    </rule>
  </sharedRules>
  <sharedProfiles>
